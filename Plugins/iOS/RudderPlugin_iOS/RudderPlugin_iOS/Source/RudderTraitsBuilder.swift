...
class RudderTraitsBuilder {
    ...
    func build() -> RudderTraits {
        return RudderTraits(address: TraitsAddress(city: self.city, country: self.country, postalCode: self.postalCode, state: self.state, street: self.street), age: self.age, birthday: self.birthday, company: TraitsCompany(name: self.companyName, id: self.companyId, industry: self.industry), createdAt: self.createdAt, description: self.description, email: self.email, firstName: self.firstName, gender: self.gender, id: self.id, lastName: self.lastName, name: self.name, phone: self.phone, title: self.title, userName: self.userName)
    }
}
