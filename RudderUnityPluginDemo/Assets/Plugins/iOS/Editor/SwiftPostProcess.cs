...
public static class SwiftPostProcess
{
    ...
    public static void OnPostProcessBuild(BuildTarget buildTarget, string buildPath)
    {
        if (buildTarget == BuildTarget.iOS)
        {
            ...
            proj.SetBuildProperty(targetGuid, "SWIFT_OBJC_BRIDGING_HEADER", Application.dataPath + "/Plugins/iOS/Source/RudderPlugin_iOS-Bridging-Header.h");
            proj.SetBuildProperty(targetGuid, "SWIFT_OBJC_INTERFACE_HEADER_NAME", "RudderPlugin_iOS-Swift.h");
